...
def run(protocol_context):
    ...
    tips_1000 = {
        protocol_context.load_labware(
            "opentronsfrg_96_tiprack_1000ul", location="10"
        ):['A1'],
        protocol_context.load_labware(
            "opentronsfrg_96_tiprack_1000ul", location="7"
        ):[],
    }

    labwares = {
        "4mL_Tray1": protocol_context.load_labware(
            "frg_24_wellplate_4000ul", location="4"
        ),
        "4mL_Tray2": protocol_context.load_labware(
            "frg_24_wellplate_4000ul", location="5"
        ),
        "15mL_Tray1": protocol_context.load_labware(
            "frg_12_wellplate_15000ul", location="6"
        ),
    }
    # spincoater

 ...
 */
  ...
  //#define XYZ_HOLLOW_FRAME // modified by JS

  // Enable to save many cycles by drawing a hollow frame on Menu Screens
  //#define MENU_HOLLOW_FRAME //modified by JS
 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       420 // modified by JS. Peak current may be limited to 0.6A on the z motor
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only. Modified by JS

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  50 // modified by JS
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  50 // modified by JS
    #define Z_STALL_SENSITIVITY  50 // modified by JS
    //#define SPI_ENDSTOPS              // TMC2130 only
    #define IMPROVE_HOMING_RELIABILITY // modified by JS
  #endif
